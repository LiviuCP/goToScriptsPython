...
def displayClipboardHelp(currentDir, fallbackOccurred):
    ...
    print("- choosing the directory from a specific entry: enter +[entry_number]")
    print("- choosing the ancestor directory of a specific entry: enter -[entry_number][ancestor_prefix]")
