...
def displayGeneralHelp(currentDir, fallbackOccurred):
    ...
    print(";[d]  -  go to ancestor directory of the current directory located at depth d (e.g. ;3 is equivalent to entering relative path ../../..)")
    ...
    print("")
    print("To navigate to an ancestor of a navigation history directory path append the corresponding suffix to the entry number:")
    print("a - parent directory, b - grandparent directory, c, d, e - next ancestors (currently the maximum allowed ancestor depth is 5)")
    print("")
    ...
    print("- for direct navigation to a quick history navigation entry please enter \',\' followed by the entry number: ,[entry_number]")
    print("- for direct navigation to ancestor directory enter the corresponding suffix (see above) after the entry number: ,[entry_number][suffix]")
...
def displayClipboardHelp(currentDir, fallbackOccurred):
    ...
    print(":td   -  setup current directory as target directory for recursive move/copy")
    print(":etd  -  erase setup target directory")
    print(":dtd  -  display setup target directory (if any)")
    print("")
    print("The target directory for recursive move/copy can also be setup from a navigation history menu by:")
    print("- choosing the directory from a specific entry: enter :td[entry_number]")
    print("- choosing the ancestor directory of a specific entry: enter :td[entry_number][ancestor_suffix]")
    print("  (see general help menu for more details regarding ancestor prefix)")
    print("")
    print("It is not supported to choose the target directory from quick navigation history.")
    print("")
