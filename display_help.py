...
def display():
    ...
    print(":     -  enter a shell command based on previous command (only available in BASH 4)")
    print(":<    -  enter command history menu")
    print("::    -  enter command history menu to edit a previous command (only available in BASH 4)")
